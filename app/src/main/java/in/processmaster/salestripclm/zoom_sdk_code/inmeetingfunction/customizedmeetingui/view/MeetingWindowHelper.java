package in.processmaster.salestripclm.zoom_sdk_code.inmeetingfunction.customizedmeetingui.view;
...
public class MeetingWindowHelper implements InMeetingShareController.InMeetingShareListener {
    ...
    private void showMiniMeetingWindow(final Context context){
        ...
        if (null == windowView) {
            ...
            openVideoView_IV = (ImageView) windowView.findViewById(R.id.openVideoView_IV);
    ...
    private class SingleTapConfirm extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent event) {
            ...
            if(mobileRTCVideoView==null || openVideoView_IV==null)
            {
                return true;
            }
            else
            {
                if(mobileRTCVideoView.getVisibility()==View.VISIBLE)
                {
                    mobileRTCVideoView.setVisibility(View.GONE);
                    openVideoView_IV.setVisibility(View.VISIBLE);

                }
                else
                {
                    mobileRTCVideoView.setVisibility(View.VISIBLE);
                    openVideoView_IV.setVisibility(View.GONE);
                }
            }
