package in.processmaster.salestripclm.sdksampleapp.ui;
...
import in.processmaster.salestripclm.sdksampleapp.initsdk.AuthConstants;
...
import in.processmaster.salestripclm.sdksampleapp.otherfeatures.scheduleforloginuser.PreMeetingExampleActivity;
import in.processmaster.salestripclm.sdksampleapp.startjoinmeeting.LoginUserStartMeetingHelper;
...
import in.processmaster.salestripclm.sdksampleapp.startjoinmeeting.joinmeetingonly.JoinMeetingHelper;
...
public class LoginUserStartJoinMeetingActivity extends Activity implements AuthConstants, MeetingServiceListener, ZoomSDKAuthenticationListener, UserLoginCallback.ZoomDemoAuthenticationListener
{
    ...
    public void onZoomSDKLoginResult(long result) {
        if(result == ZoomAuthenticationError.ZOOM_AUTH_ERROR_SUCCESS) {
            ...
            Log.e("errorMessageghfh", String.valueOf(result));
